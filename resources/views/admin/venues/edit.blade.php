...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.venues.update", [$venue->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            @include('admin.partials.multilang_hint', ['mlFields' => ['name', 'address', 'description'], 'isCreate' => false])
            ...
            <div class="form-group {{ $errors->has('latitude') ? 'has-error' : '' }}">
                ...
                <input type="text" id="latitude" name="latitude" class="form-control" value="{{ old('latitude', isset($venue) ? $venue->latitude : '') }}">
            ...
            <div class="form-group {{ $errors->has('longitude') ? 'has-error' : '' }}">
                ...
                <input type="text" id="longitude" name="longitude" class="form-control" value="{{ old('longitude', isset($venue) ? $venue->longitude : '') }}">
            ...
            <div class="form-group {{ $errors->has('google_maps_url') ? 'has-error' : '' }}">
                <label for="google_maps_url">{{ trans('cruds.venue.fields.google_maps_url') }}</label>
                <input type="text" id="google_maps_url" name="google_maps_url" class="form-control" value="{{ old('google_maps_url', isset($venue) ? $venue->google_maps_url : '') }}" placeholder="https://maps.google.com/?q=...">
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.venue.fields.google_maps_url_helper') }}
                </p>
            </div>
