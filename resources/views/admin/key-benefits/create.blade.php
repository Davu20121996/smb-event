...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.keyBenefit.title_singular') }}
    </div>

    <div class="card-body">
        <form action="{{ route("admin.key-benefits.store") }}" method="POST" enctype="multipart/form-data">
            @csrf
            @include('admin.partials.multilang_hint', ['mlFields' => ['title', 'description'], 'isCreate' => true])
