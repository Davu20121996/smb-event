...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.speakers.update", [$speaker->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            @include('admin.partials.multilang_hint', ['mlFields' => ['name', 'role', 'company', 'description', 'full_description'], 'isCreate' => false])
            ...
            <div class="form-group {{ $errors->has('role') ? 'has-error' : '' }}">
                <label for="role">{{ trans('cruds.speaker.fields.role') }}</label>
                <input type="text" id="role" name="role" class="form-control" value="{{ old('role', isset($speaker) ? $speaker->role : '') }}">
                @if($errors->has('role'))
                    <p class="help-block">
                        {{ $errors->first('role') }}
                    </p>
                @endif
                <p class="helper-block">
                    {{ trans('cruds.speaker.fields.role_helper') }}
                </p>
            </div>
            <div class="form-group {{ $errors->has('company') ? 'has-error' : '' }}">
                <label for="company">{{ trans('cruds.speaker.fields.company') }}</label>
                <input type="text" id="company" name="company" class="form-control" value="{{ old('company', isset($speaker) ? $speaker->company : '') }}">
                ...
                @endif
                <p class="helper-block">
                    {{ trans('cruds.speaker.fields.company_helper') }}
                </p>
            </div>
