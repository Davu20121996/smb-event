...
<head>
    ...
    <link href="<?php echo e(asset('vendor/admin/select2/css/select2.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('vendor/admin/datatables/jquery.dataTables.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('vendor/admin/datatables/dataTables.bootstrap4.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('vendor/admin/datatables/select.dataTables.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('vendor/admin/datatables/buttons.dataTables.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('vendor/admin/datetimepicker/css/bootstrap-datetimepicker.min.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('vendor/admin/dropzone.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('css/custom.css')); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('css/design-system.css') . '?v=' . @filemtime(public_path('css/design-system.css'))); ?>" rel="stylesheet" />
    <link href="<?php echo e(asset('css/admin-theme.css') . '?v=' . @filemtime(public_path('css/admin-theme.css'))); ?>" rel="stylesheet" />
...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    ...
    <script src="<?php echo e(asset('vendor/admin/jquery/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/bootstrap/js/bootstrap.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/popper/popper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/select2/js/select2.full.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/moment/moment.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/datatables/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/datatables/dataTables.bootstrap4.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/datatables/dataTables.buttons.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/datatables/dataTables.select.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/datatables/buttons.flash.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/datatables/buttons.html5.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/datatables/buttons.print.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/datatables/buttons.colVis.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/pdfmake/pdfmake.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/pdfmake/vfs_fonts.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/jszip/jszip.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/ckeditor/ckeditor.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/moment/moment.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/datetimepicker/js/bootstrap-datetimepicker.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/select2/js/select2.full.min.js')); ?>"></script>
    <script src="<?php echo e(asset('vendor/admin/dropzone.js')); ?>"></script>
  ...
  let languages = {
    'en': '<?php echo e(asset('vendor/admin/datatables/i18n/English.json')); ?>'
  };
...
</html><?php /**PATH E:\laragon\www\laravel\EMS-smb-v3\EMS-smb\resources\views/layouts/admin.blade.php ENDPATH**/ ?>