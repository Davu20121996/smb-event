                ...
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="max-width:600px; width:100%; background:#ffffff; border-radius:12px; overflow:hidden; box-shadow:0 10px 30px rgba(0,0,0,.15);">
                    ...
                    <tr>
                        <td style="background:#2563eb; color:#ffffff; text-align:center; padding:32px 24px;">
                            ...
                            <h1 style="margin:0; font-size:22px; font-weight:800;"><?php echo e($event->name ?? __('frontend.nav_event')); ?></h1>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:32px;">
                            ...
                            <p style="margin:0 0 16px;">
                                <?php echo e(__('mail.greeting', ['name' => $attendee->name])); ?>

                            </p>
                            <p style="margin:0 0 24px; line-height:1.6; color:#444;">
                                <?php echo e(__('mail.thanks')); ?>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:28px 0;">
                                <tr>
                                    <td align="center">
                                        <a href="<?php echo e($confirmUrl); ?>" style="display:inline-block; background:#2563eb; color:#ffffff; padding:14px 48px; border-radius:8px; font-size:16px; font-weight:700; text-decoration:none;">
                                            &#x2705; Verify My Email
                                        </a>
                                    </td>
                                </tr>
                            ...
                            <p style="margin:0 0 24px; font-size:13px; background:#f1f5f9; border-radius:6px; padding:10px 12px; color:#374151; word-break:break-all;"><?php echo e($confirmUrl); ?></p>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="font-size:13px;">
                                <tr>
                                    ...
                                    <td style="padding:5px 0; font-weight:600;"><?php echo e($attendee->name); ?></td>
                                </tr>
                                <tr>
                                    <td style="color:#6b7280; padding:5px 0; width:120px;">Email:</td>
                                    <td style="padding:5px 0; font-weight:600;"><?php echo e($attendee->email); ?></td>
                                </tr>
                                <?php if($attendee->company): ?>
                                <tr>
                                    <td style="color:#6b7280; padding:5px 0; width:120px;">Company:</td>
                                    <td style="padding:5px 0; font-weight:600;"><?php echo e($attendee->company); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if($attendee->phone): ?>
                                <tr>
                                    <td style="color:#6b7280; padding:5px 0; width:120px;">Phone:</td>
                                    <td style="padding:5px 0; font-weight:600;"><?php echo e($attendee->phone); ?></td>
                                </tr>
                                <?php endif; ?>
                                <?php if($attendee->company_size_label): ?>
                                <tr>
                                    <td style="color:#6b7280; padding:5px 0; width:120px;">Company size:</td>
                                    <td style="padding:5px 0; font-weight:600;"><?php echo e($attendee->company_size_label); ?></td>
                                </tr>
                                <?php endif; ?>
                            </table>
...
</html><?php /**PATH E:\laragon\www\laravel\EMS-smb-v3\EMS-smb\resources\views/emails/event-registration.blade.php ENDPATH**/ ?>