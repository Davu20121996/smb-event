<?php $__env->startSection('seo_title', __('frontend.seo_event_confirmed_title', ['name' => $event->name ?? 'SMB+'])); ?>
<?php $__env->startSection('seo_description', __('frontend.seo_event_confirmed_desc')); ?>
  ...
  <section id="event-confirmed" class="wow fadeIn section-tight">
    <div class="container">
      <div class="text-center" style="max-width: 640px; margin: 0 auto;">
        ...
        <h2><?php echo e(__('frontend.event_confirmed')); ?></h2>
        <p class="body-md mt-3" style="color: var(--ink-muted);">
          <?php echo e(__('frontend.event_confirmed_sub')); ?>
...
<?php echo $__env->make('layouts.main', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\laragon\www\laravel\EMS-smb-v3\EMS-smb\resources\views/event-confirmed.blade.php ENDPATH**/ ?>